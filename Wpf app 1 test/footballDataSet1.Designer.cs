...
namespace Wpf_app_1_test {
    ...
    public partial class footballDataSet1 : global::System.Data.DataSet {
        ...
        public partial class playersDataTable : global::System.Data.TypedTableBase<playersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public playersRow AddplayersRow(string playerName, string phoneNumber, int age) {
...
namespace Wpf_app_1_test.footballDataSet1TableAdapters {
    ...
    public partial class playersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[players] ([playerName], [phoneNumber], [age]) VALUES (@playerN" +
                "ame, @phoneNumber, @age);\r\nSELECT id, playerName, phoneNumber, age FROM players " +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[players] SET [playerName] = @playerName, [phoneNumber] = @phoneNumb" +
                "er, [age] = @age WHERE (([id] = @Original_id) AND ([age] = @Original_age));\r\nSEL" +
                "ECT id, playerName, phoneNumber, age FROM players WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, playerName, phoneNumber, age FROM dbo.players";
        ...
        public virtual int Insert(string playerName, string phoneNumber, int age) {
            if ((playerName == null)) {
        ...
        public virtual int Update(string playerName, string phoneNumber, int age, int Original_id, int Original_age, int id) {
            if ((playerName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string playerName, string phoneNumber, int age, int Original_id, int Original_age) {
            return this.Update(playerName, phoneNumber, age, Original_id, Original_age, Original_id);
        }
    }
