...
namespace Wpf_app_1_test {
    ...
    public partial class footballDataSet : global::System.Data.DataSet {
        ...
        public partial class playersDataTable : global::System.Data.TypedTableBase<playersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public playersRow AddplayersRow(string playerName, string phoneNumber, int age, string fatherName) {
        ...
        public partial class playersRow : global::System.Data.DataRow {
            ...
            public string fatherName {
                get {
                    try {
                        return ((string)(this[this.tableplayers.fatherNameColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'fatherName\' in table \'players\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableplayers.fatherNameColumn] = value;
                }
            }
            ...
            public bool IsfatherNameNull() {
                return this.IsNull(this.tableplayers.fatherNameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetfatherNameNull() {
                this[this.tableplayers.fatherNameColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Wpf_app_1_test.footballDataSetTableAdapters {
    ...
    public partial class playersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[players] WHERE (([id] = @Original_id) AND ([age] = @Original_a" +
                "ge))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[players] ([playerName], [phoneNumber], [age], [fatherName]) VA" +
                "LUES (@playerName, @phoneNumber, @age, @fatherName);\r\nSELECT id, playerName, pho" +
                "neNumber, age, fatherName FROM players WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[players] SET [playerName] = @playerName, [phoneNumber] = @phoneNumber, [age] = @age, [fatherName] = @fatherName WHERE (([id] = @Original_id) AND ([age] = @Original_age));
SELECT id, playerName, phoneNumber, age, fatherName FROM players WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, playerName, phoneNumber, age, fatherName FROM dbo.players";
        ...
        public virtual int Insert(string playerName, string phoneNumber, int age, string fatherName) {
            if ((playerName == null)) {
        ...
        public virtual int Update(string playerName, string phoneNumber, int age, string fatherName, int Original_id, int Original_age, int id) {
            if ((playerName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string playerName, string phoneNumber, int age, string fatherName, int Original_id, int Original_age) {
            return this.Update(playerName, phoneNumber, age, fatherName, Original_id, Original_age, Original_id);
        }
    }
